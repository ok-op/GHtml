<!-- JavaScript for copying code and opening links -->
	const canvas = document.getElementById("matrix");
        ...
        const words = [
            { text: "𝐀ɴɢᴇʟ 𝐎ᴘ", color: "#ffffff" }, // Red
            { text: "❤️", color: "#ff69b4" }, // Pink
            { text: "𝗪𝗢𝗢𝗗𝗰𝗿𝗮𝗳𝘁", color: "#00ff00" } // Green
        ];
        ...
        function decodeBase64() {
			...
			try {
				...
				document.getElementById('base64Result').innerHTML = `<pre>${decoded}</pre>`;  // এখানে পরিবর্তন করা হয়েছে
			} catch (e) {
